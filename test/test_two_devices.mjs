...
// È il test end-to-end che mancava e che avrebbe colto i bug di oggi.
...
ok('A è in famiglia dopo create', !!profA.famiglia_id);

// 3. A non può creare una seconda famiglia (anti-doppione)
const cre2 = await cloud.rpc('create_family', { p_nome:'Doppia' });
ok('create rifiutato se già in famiglia', !!cre2.error);
...
//    (prima deve uscire, altrimenti "già in famiglia")
